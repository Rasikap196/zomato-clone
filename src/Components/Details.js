...
class Details extends React.Component {
    ...
    handlePayment = (event) => {
        ...
        if (!email) {
            alert('Please fill email field and then Proceed...');
        }
        else {
            // Payment API Call 
            const paymentObj = {
    ...
    render() {
        const { restaurant, menuItemsModalIsOpen, formsModalIsOpen, galleryModalIsOpen, menuItems, subTotal, restaurantId } = this.state;
        return (
            <div>
                <div>
